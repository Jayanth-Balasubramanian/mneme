...
4. [#4 Review lesson units and regenerate a single unit](https://github.com/Jayanth-Balasubramanian/mneme/issues/4)
   ...
   - Current caveat: PR #10 merge state is `DIRTY`, and checks have not reported yet. It needs review gates, then rebase/conflict resolution and green checks before merge.
